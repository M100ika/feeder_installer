...
### Основные Особенности Версии 2.2
...
- **Журналы хранятся 10 дней**: Журналы системы теперь хранятся в течение 10 дней, обеспечивая оптимальный баланс между историей и использованием дискового пространства.
...
из таблицы по ссылке выше и перенесите данные в файл config.ini. К примеру
    *****************************************
    ...
    [Calibration]
    taring_rfid = b'435400041111' 
    scaling_rfid = b'435400041111' 
    weight = 80
    offset = 16766507
...
**Процедура Калибровки Веса**
    1. Подготовка:
    - Установите на весах заданный вес, указанный в параметре weight.
    2. Выполнение:
    - Закройте датчик прерывания луча.
